...
if($_POST)
{
    $to_Email   	= "grace.cuttino@gmail.com"; //Replace with recipient email address
    $subject        = 'Graceful Dezigns Contact Inquiry'; //Subject line for emails
    ...
    */
    ...
    if(!$sentMail)
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_Name .' Thanks for connecting!'));
        die($output);
    }
}
?>